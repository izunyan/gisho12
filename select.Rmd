...
* 読み込みの様々な方法については拙書[『Rで読むExcelファイル』](https://techbookfest.org/product/4794168259903488?productVariantID=5913872206659584)参照
...
* 関心ある変数が指定された範囲に含まれていれば`:`（コロン）でつなげて取得できる
...
* dfデータで変数bill_length_mmからbody_mass_gまでの並びの計4列を文字ベクトルにしたうえでselectで選んでデータフレームを表示させよう
