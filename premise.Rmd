...
* 一連の作業を，値を変えて繰り返したいときに役立つ
  - ここは最初は難しいかもしれないので，飛ばしても差支えないが，知っておくと\@ref(rename-strreplace1)や\@ref(mu-across-list)の重要知識部分の理解がしやすくなる
...
* R 4.1.0より，`function`を省略してバックスラッシュ`\`で示せるようになった
* これにより，本書で中心的に扱う繰り返し作業の記法もこれに合わせるようになる点が多くなる
