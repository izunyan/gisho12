...
* `rowSums()`の中で~~across()が使える~~ので，あとは定義した項目のオブジェクトを指定していくだけ
  + `dplyr 1.1.0`より`pick()`に変更([tidyverse blogの記事](https://www.tidyverse.org/blog/2023/02/dplyr-1-1-0-pick-reframe-arrange/); [適用例](https://stackoverflow.com/questions/76051075/rowsum-several-groups-of-columns-with-a-particular-pattern-of-names))
